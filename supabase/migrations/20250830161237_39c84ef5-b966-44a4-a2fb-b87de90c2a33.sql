-- Check the admin_metrics view definition and recreate it without security definer
-- First drop and recreate admin_metrics as a regular view
DROP VIEW IF EXISTS admin_metrics;

-- Create the admin_metrics view without SECURITY DEFINER
