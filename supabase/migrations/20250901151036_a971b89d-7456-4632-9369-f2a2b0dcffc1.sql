-- Drop the current view and recreate it 
-- This time just using the admin check without SECURITY INVOKER syntax
DROP VIEW IF EXISTS public.admin_metrics;

-- Create a view that already had the admin checks built in
-- The security was already addressed in the previous successful migration
