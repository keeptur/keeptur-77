...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-lg hover:scale-105 transition-all duration-300",
        destructive:
        ...
        hero: "gradient-hero text-white border-0 hover:shadow-glow hover:scale-105 transition-all duration-300 font-semibold",
        ...
        glass: "glass-effect text-white hover:bg-white/20 border-white/30 transition-all duration-300",
      },
      size: {
